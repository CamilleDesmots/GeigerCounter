...
/**
 * Provide CPM of the last two hours with a refreshment every minutes.
 * @author camilledesmots
 */
@Named
@Singleton
@ApplicationScoped
public class DataProvider11 implements Serializable {

    private static final Logger LOGGER = Logger.getLogger(DataProvider11.class.getName());
    ...
    public DataProvider11() {
//        LOGGER.log(Level.FINEST, "In the method DataProvider().");
...
//        LOGGER.log(Level.FINEST, "The list has {2} records for the period [{0}...{1}] {2}", new Object[]{this.dateBegin, this.dateEnd, this.listCpm.stream().count()});
    ...
    /**
     * Return the list of CPM of the last 2 hours
     * @return List of CPM
     */
